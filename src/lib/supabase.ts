...
// Função utilitária para adicionar timeout a promessas com timeout de 300 segundos (5 minutos)
export const withTimeout = <T,>(promise: Promise<T>, timeoutMs: number = 300000): Promise<T> => {
